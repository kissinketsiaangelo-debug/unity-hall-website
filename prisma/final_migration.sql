...
DROP TYPE IF EXISTS "ForumCategory" CASCADE;
...
DROP TYPE IF EXISTS "PollCategory" CASCADE;
...
DROP TYPE IF EXISTS "EmergencyStatus" CASCADE;
DROP TYPE IF EXISTS "SafeStatus" CASCADE;
